...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		M(17), M(18), KC_X, DE_Y, DE_Z, KC_A, KC_B, KC_C, 
		M(29), DE_LESS, DE_MORE, DE_LBRC, DE_RBRC, M(7), M(8), KC_BSPC, 
		M(19), DE_LPRN, DE_RPRN, DE_SLSH, DE_ASTR, DE_MINS, DE_PLUS, M(1), 
		M(20), M(3), M(26), M(25), KC_7, KC_8, KC_9, M(2), 
		M(21), M(14), M(16), DE_PERC, KC_4, KC_5, KC_6, DE_EQL, 
		KC_LSFT, DE_CIRC, M(12), M(13), KC_1, KC_2, KC_3, KC_ENT, 
		LT(1, KC_NO), DE_PIPE, DE_AMPR, KC_COMM, KC_0, M(0), KC_DOT),

	KEYMAP(
		M(31), M(34), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_D, 
		M(30), M(5), M(6), DE_LCBR, DE_RCBR, M(9), M(10), KC_TRNS, 
		M(22), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		M(23), M(4), M(27), M(28), KC_HOME, KC_UP, KC_PGUP, KC_TRNS, 
		M(24), KC_TRNS, M(33), DE_HASH, KC_LEFT, KC_TRNS, KC_RGHT, M(32), 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_END, KC_DOWN, KC_PGDN, TO(2), 
		KC_TRNS, KC_TRNS, DE_AT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

	KEYMAP(
		M(17), M(18), KC_X, DE_Y, DE_Z, KC_A, KC_B, KC_C, 
		M(29), DE_LESS, DE_MORE, DE_LBRC, DE_RBRC, M(69), M(7), KC_BSPC, 
		M(19), DE_LPRN, DE_RPRN, M(35), M(36), DE_MINS, DE_PLUS, M(1), 
		M(20), M(3), M(26), M(25), KC_7, KC_8, KC_9, M(2), 
		M(21), M(68), M(16), DE_PERC, KC_4, KC_5, KC_6, DE_EQL, 
		KC_LSFT, M(38), M(42), M(43), KC_1, KC_2, KC_3, KC_ENT, 
		LT(3, KC_NO), DE_PIPE, DE_AMPR, KC_COMM, KC_0, M(0), KC_DOT),

	KEYMAP(
		M(31), M(34), KC_TRNS, KC_TRNS, M(15), KC_TRNS, KC_TRNS, KC_D, 
		M(30), M(5), M(6), DE_LCBR, DE_RCBR, M(37), M(10), KC_TRNS, 
		M(39), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		M(40), M(4), M(27), M(28), KC_HOME, KC_UP, KC_PGUP, KC_TRNS, 
		M(41), M(44), M(33), DE_HASH, KC_LEFT, KC_TRNS, KC_RGHT, M(32), 
		KC_TRNS, DE_CIRC, M(12), M(13), KC_END, KC_DOWN, KC_PGDN, TO(4), 
		KC_TRNS, KC_TRNS, DE_AT, KC_TRNS, KC_TRNS, KC_TRNS, M(11)),

	KEYMAP(
		M(54), M(55), KC_X, DE_Y, DE_Z, KC_A, KC_B, KC_C, 
		M(65), DE_LESS, DE_MORE, DE_LBRC, DE_RBRC, M(45), M(46), KC_BSPC, 
		M(56), DE_LPRN, DE_RPRN, DE_SLSH, DE_ASTR, DE_MINS, DE_PLUS, M(1), 
		M(57), M(3), M(64), M(62), KC_7, KC_8, KC_9, M(2), 
		M(58), M(51), M(53), DE_PERC, KC_4, KC_5, KC_6, DE_EQL, 
		KC_LSFT, M(48), M(49), M(50), KC_1, KC_2, KC_3, KC_ENT, 
		LT(5, KC_NO), DE_PIPE, DE_AMPR, KC_COMM, KC_0, M(0), KC_DOT),

	KEYMAP(
		M(31), M(34), KC_TRNS, KC_TRNS, M(100), M(67), KC_TRNS, KC_D, 
		M(30), M(5), M(6), DE_LCBR, DE_RCBR, M(66), M(47), KC_TRNS, 
		M(59), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		M(60), M(4), KC_TRNS, M(63), KC_HOME, KC_UP, KC_PGUP, KC_TRNS, 
		M(61), KC_TRNS, M(33), DE_HASH, KC_LEFT, KC_TRNS, KC_RGHT, M(32), 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_END, KC_DOWN, KC_PGDN, TO(6), 
		KC_TRNS, KC_TRNS, DE_AT, KC_TRNS, KC_TRNS, KC_TRNS, M(52)),

	KEYMAP(
		M(75), M(76), KC_X, DE_Y, DE_Z, KC_A, KC_B, KC_C, 
		M(80), DE_LESS, DE_MORE, DE_LBRC, DE_RBRC, M(89), M(90), KC_BSPC, 
		M(92), DE_LPRN, DE_RPRN, M(83), DE_ASTR, DE_MINS, DE_PLUS, M(1), 
		M(93), M(3), M(84), M(25), KC_7, KC_8, KC_9, M(2), 
		M(94), M(91), M(77), DE_PERC, KC_4, KC_5, KC_6, DE_EQL, 
		KC_LSFT, DE_CIRC, M(12), M(13), KC_1, KC_2, KC_3, KC_ENT, 
		LT(7, KC_NO), DE_PIPE, DE_AMPR, KC_COMM, KC_0, M(0), KC_DOT),

	KEYMAP(
		M(98), M(99), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_D, 
		M(30), M(73), M(74), DE_LCBR, DE_RCBR, M(82), M(81), KC_TRNS, 
		...
		KC_TRNS, KC_TRNS, DE_AT, KC_TRNS, KC_TRNS, KC_TRNS, M(78)),
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt) {
	...
	switch (id) {
		...
		case 9:
			if (record->event.pressed) {
				return MACRO( T(1), T(0), T(GRAVE), END );
			}
			break;
		case 10:
			if (record->event.pressed) {
		...
		case 12:
			if (record->event.pressed) {
				return MACRO( T(GRAVE), T(2), END );
			}
			break;
		case 13:
			if (record->event.pressed) {
				return MACRO( T(GRAVE), T(3), END );
			}
			break;
		case 14:
			if (record->event.pressed) {
				return MACRO( T(GRAVE), D(LSFT), T(8), U(LSFT), T(SLSH), T(1), D(LSFT), T(9), U(LSFT), END );
			}
			break;
		case 15:
			if (record->event.pressed) {
		...
		case 37:
			if (record->event.pressed) {
				return MACRO( T(1), T(0), T(DOT), T(GRAVE), END );
			}
			break;
		case 38:
			if (record->event.pressed) {
				return MACRO( T(DOT), T(GRAVE), END );
			}
			break;
		case 39:
			if (record->event.pressed) {
		...
		case 42:
			if (record->event.pressed) {
				return MACRO( T(DOT), T(GRAVE), T(2), END );
			}
			break;
		case 43:
			if (record->event.pressed) {
				return MACRO( T(DOT), T(GRAVE), T(3), END );
			}
			break;
		case 44:
			if (record->event.pressed) {
		...
		case 67:
			if (record->event.pressed) {
				return MACRO( T(N), T(P), T(DOT), T(A), T(R), T(R), T(A), T(Z), D(LSFT), T(8), U(LSFT), D(RALT), T(8), U(RALT), END);
			}
			break;
		case 68:
			if (record->event.pressed) {
				return MACRO( T(DOT), T(GRAVE), D(LSFT), T(8), U(LSFT), T(SLSH), T(1), D(LSFT), T(9), U(LSFT), END );
			}
			break;
		case 69:
			if (record->event.pressed) {
		...
		case 75:
			if (record->event.pressed) {
				return MACRO( D(RALT), T(MINS), U(RALT), T(S), T(U), T(M), D(LSFT), T(SLSH), U(LSFT), D(RALT), T(7), T(0), U(RALT), T(GRAVE), D(RALT), T(7), T(0), U(RALT), T(LEFT), T(LEFT), T(LEFT), T(LEFT), END );
			}
			break;
		case 76:
			if (record->event.pressed) {
				return MACRO( D(RALT), T(MINS), U(RALT), T(P), T(R), T(O), T(D), D(LSFT), T(SLSH), U(LSFT), D(RALT), T(7), T(0), U(RALT), T(GRAVE), D(RALT), T(7), T(0), U(RALT), T(LEFT), T(LEFT), T(LEFT), T(LEFT), END );
			}
			break;
		case 77:
			if (record->event.pressed) {
		...
		case 81:
			if (record->event.pressed) {
				return MACRO( T(E), T(GRAVE), D(RALT), T(7), U(RALT), END );
			}
			break;
		case 82:
			if (record->event.pressed) {
				return MACRO( T(1), T(0), T(GRAVE), D(RALT), T(7), U(RALT), END );
			}
			break;
		case 83:
			if (record->event.pressed) {
